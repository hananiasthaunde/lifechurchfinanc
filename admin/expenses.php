...
try {
    ...
    $stmt_exp = $conn->prepare("SELECT e.*, c.name as category_name, u.name as user_name FROM expenses e JOIN categories c ON e.category_id = c.id LEFT JOIN users u ON e.user_id = u.id WHERE e.church_id = ? ORDER BY e.transaction_date DESC, e.id DESC LIMIT 20");
        ...
        <div class="flex-1 flex flex-col w-full">
            ...
            <main class="flex-1 p-4 sm:p-6 overflow-y-auto">
                ...
                <div class="bg-white rounded-lg shadow p-4 sm:p-6 mt-8">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4">Últimas Saídas Registadas</h2>
